  ...
  return (
    <>
      ...
      <div className="mt-8 space-y-12">
        <div id="shift" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Strategic Shift: Conversions Over Traffic</h3>
        ...
        <div id="tier1" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Tier 1: Category Keywords (Extreme Bottom of Funnel)</h3>
          <div className="mt-4 space-y-3">
        ...
        <div id="tier2" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Tier 2: Comparison & Alternative Keywords (Extreme Bottom of Funnel)</h3>
          <div className="mt-4 space-y-3">
        ...
        <div id="tier3" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Tier 3: Jobs-to-be-Done Keywords (Mid-Funnel)</h3>
          <div className="mt-4 space-y-3">
        ...
        <div id="interview" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Customer Interview Questions for Keyword Discovery</h3>
          <div className="mt-4 space-y-3">
        ...
        <div id="competitor" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Competitor Analysis Process (Pain Point SEO Lens)</h3>
          <div className="mt-4 space-y-3">
...
- Informational: 0.5`}</CodeBlock>
        ...
        <div id="workflow" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Keyword Research Workflow (Pain Point SEO Method)</h3>
          <div className="mt-4 space-y-3">
        ...
        <div id="cluster" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Topic Cluster Strategy (Conversion-Focused)</h3>
          <div className="mt-4 space-y-3">
        ...
        <div id="measuring" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Measuring Success: Conversions, Not Traffic</h3>
          <div className="mt-4 space-y-3">
        ...
        <div id="zerovolume" className="scroll-mt-header pb-10 border-b border-stone-200">
          <h3 className="font-serif text-2xl font-semibold text-ink">Advanced: "Zero Volume" Keyword Strategy</h3>
          <div className="mt-4 space-y-3">
